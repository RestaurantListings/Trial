...
<head>
    ...
    <!--
    <script src="{{ asset('assets/js/jquery-ias.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/callbacks.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/extension/trigger.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/extension/spinner.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/extension/noneleft.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/extension/paging.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/extension/history.js') }}" type="text/javascript"></script>
-->
...
<!--Script for Infinite Page Scroll
<script type="text/javascript">
    var ias = jQuery.ias({
        container: "#rest_review_box_container",
        item: ".rest_review_box",
