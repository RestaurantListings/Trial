            ...
            <div class="search-results">
                ...
                <div class="search-results-item">
                    ...
                    <div class="results-item-info">
                        ...
                        <br>
                        <a style="padding:5px 10px;background-color:#b50a03;color:#fff;margin-top:10px;margin-bottom:10px;" class="request_order_btn btn-rl-default" href="{{ url('write-a-review/'.$r->permalink) }}">Write a review</a>
                        <br>
                    </div>
                </div>
                @endforeach
